            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 md:gap-4 max-w-6xl mx-auto py-4 sm:py-6 md:py-8 px-2 sm:px-4">
                        <button
                            className="flex items-center  text-xs sm:text-sm md:text-base hover:bg-black hover:text-white transition-all duration-300 py-2 px-3 rounded-md"
                        ...
                        <div className="flex flex-wrap items-center gap-1 sm:gap-2">
                            {[...Array(totalPages)].map((item, index) => (
                                <button
                                    ...
                                    className={`text-xs sm:text-sm md:text-base py-2 px-3 rounded-md transition-all duration-300
